...
public class XImgSimpleImageInfo {
    private int height;
    private int width;
    private String mimeType;

    private XImgSimpleImageInfo() {

    }

    public XImgSimpleImageInfo(File file) throws IOException {
    ...
    public XImgSimpleImageInfo(InputStream is) throws IOException {
            processStream(is);
    }

    public XImgSimpleImageInfo(byte[] bytes) throws IOException {
