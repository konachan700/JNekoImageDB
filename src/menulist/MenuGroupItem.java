...
public class MenuGroupItem extends VBox {
        ...
        private ImageView 
                itemIcon10x10 = new ImageView(new Image(getClass().getResourceAsStream("arrow2.png"))),
                groupIcon16x16 = new ImageView(new Image(getClass().getResourceAsStream("arrow1.png")));
        ...
        public final void addLabel(String ID, String text) {
            final ImageView iw = new ImageView(new Image(getClass().getResourceAsStream("arrow2.png")));
            itemIcons.put(ID, iw);
