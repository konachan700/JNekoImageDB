...
//            pathChangeLock = false;
    ...
    private final InfiniteListPaneActionListener ilal = (int actionType, double windowWidth, double windowVisibleHeight, double windowTotalHeight) -> {
        switch (actionType) {
            case InfiniteListPane.ACTION_TYPE_V_RESIZE:
                ...
                int temporaryItemCountOnOneColoumn =  ((int)winVH) / itemSizeV;
            ...
            case InfiniteListPane.ACTION_TYPE_H_RESIZE:
                ...
                final int temporaryItemCountOnOneLine = ((int)winWidth) / itemSizeH;
    ...
    public InfiniteFileList(XImgCrypto c, String dbname) {
        super();
        previewGen = new XImgPreviewGen(c, XImg.PreviewType.cache, dbname, (Image im, Path path) -> {
            Platform.runLater(() -> {
                displayImg(im, path);
            });
        });
...
//        }
    ...
    public final void reinit() {
        ...
        this.setRowSize(itemSizeV);
        this.setScrollTop();
        
        ilal.onItemsUpdateNeeded(InfiniteListPane.ACTION_TYPE_V_RESIZE, winWidth, winVH, winVH);
        ilal.onItemsUpdateNeeded(InfiniteListPane.ACTION_TYPE_H_RESIZE, winWidth, winVH, winVH);
